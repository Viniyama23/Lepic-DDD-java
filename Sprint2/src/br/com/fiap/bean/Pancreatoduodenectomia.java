...
public class Pancreatoduodenectomia extends Cadastro {
	private int nivelDeDificuldade , nivelDeDetalhes, tempo;
	
	//construtor vazio
	public Pancreatoduodenectomia() {
		
	}
	
	//construtor com passagem de parametro
	public Pancreatoduodenectomia(int tempo, int nivelDeDificuldade, int nivelDeDetalhes) {
		this.tempo = tempo;
