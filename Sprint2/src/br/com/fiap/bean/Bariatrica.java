...
public class Bariatrica extends Cadastro {
	private int tempo , nivelDeDificuldade , nivelDeDetalhes;
	...
	public Bariatrica(int tempo, int nivelDeDificuldade, int nivelDeDetalhes) {
		this.tempo = tempo;
